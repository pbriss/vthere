...
function resizeContainer() {
  if (!window.videoContainer) {
    window.videoContainer = document.getElementById('video-container');
  }

  window.videoContainer.style.width = window.innerWidth + 'px';
  window.videoContainer.style.height = window.innerHeight + 'px';
}
